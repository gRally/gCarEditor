...
{
	public class grsCarPatternShaderGUI : ShaderGUI
	{
		...
		private static class Styles
		{
			...
			public static GUIContent decalText = new GUIContent("Decal", "Decal (RGB) and Transparency (A)");
            public static GUIContent numberPlateText = new GUIContent("NumberPlate", "Number plate (RGB)");
        ...
        MaterialProperty numberPlateMap = null;
        MaterialProperty albedoColor = null;
		MaterialProperty albedoColor1 = null;
		MaterialProperty albedoColor2 = null;
		MaterialProperty albedoColor3 = null;
		...
		public void FindProperties (MaterialProperty[] props)
		{
			...
			decalMap = FindProperty ("_DecalTex", props);
            numberPlateMap = FindProperty("_DecalTex", props);
            albedoColor = FindProperty ("_Color", props);
			albedoColor1 = FindProperty ("_Color1", props);
			albedoColor2 = FindProperty ("_Color2", props);
			albedoColor3 = FindProperty ("_Color3", props);
		...
		*/
		...
		void DoAlbedoArea(Material material)
		{
			...
			m_MaterialEditor.ShaderProperty(albedoColor, "Color for R");
			m_MaterialEditor.ShaderProperty(albedoColor1, "Color for G");
			m_MaterialEditor.ShaderProperty(albedoColor2, "Color for B");
			m_MaterialEditor.ShaderProperty(albedoColor3, "Color for A");
		...
		void DoDecalArea(Material material)
		{
			m_MaterialEditor.TexturePropertySingleLine(Styles.decalText, decalMap);
			if (((BlendMode)material.GetFloat("_Mode") == BlendMode.Cutout))
			{
				m_MaterialEditor.ShaderProperty(alphaCutoff, Styles.alphaCutoffText.text, MaterialEditor.kMiniTextureFieldLabelIndentLevel+1);
			}
